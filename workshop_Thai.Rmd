...
* __run_hardy_withinPop.sh__ - a shell script that I wrote for performing Hardy-Weinberg equilibrium test within each population (optional)
* __[ADMIXTURE](https://dalexander.github.io/admixture)__ - a widely used model-based clustering software for population structure analysis
...
# This are the parameters have been shown working well with our genotyping array data
